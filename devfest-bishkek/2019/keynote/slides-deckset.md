...
- Alan Richardson
- [eviltester.com/conference/devfestbishkek2019_conference](https://www.eviltester.com/conference/devfestbishkek2019_conference)
- EvilTester.com
- @EvilTester
- CompendiumDev.co.uk
...
![125%](images/health-check-notes-movie.gif)

---

![130%](images/health-check-issue-notes-example.gif)
...
- Planning: exploratory process of weighing up factors, asking questions and making decisions
...
![inline, 120%](images/tracks-chosen-change-to-test.png)
...
![125%](images/recon-notes-movie.gif)
...
- Selecting Tooling is an evolving process based on the needs of the testing and the application.
...
![130%](images/debrief-session-notes-movie.gif)
...
![75%](images/2019-11-28_11-56-44-modelling-session.png)
...
![inline](images/2019-11-28_11-56-44-modelling-session-planning.png)
...
- Plan only as far as you need to to support the next session
...
![inline](images/2019-11-28_14-03-49-mindmap-plan-mm.png)
...
![130%](images/coverage-session-notes-movie.gif)
...
- Manipulation at a technical level
   - e.g. resend requests, DOM manipulation, bypass GUI, Tools mandatory
...
- Work in GUI. Observe impact via HTTP (I can see if JS or Server validation used)
...
![120%](images/exploratory-session-notes-movie.gif)
...
![inline](images/2019-11-29_13-53-45-tech-exploratory-session-notes-subset.png)

---

# What I Found

- ZAProxy - session only saveable to Documents, not sub folder
- Tracks no error message when incorrect status used for context, value ignored, 200 OK
...
- API vs GUI mismatch? a forms API and a JSON API
- limited observation - did not include DB tools, had to use System exports to check data.
...
- proxy HTTP Observation, Inspection & Manipulation
...
- More information -> more risk of going off charter or off time
...
![inline, 130%](images/basic-flow.png)
...
- tooling support for observation, interrogation. manipulation appropriate for scope and aim

i.e. I didn't use any extra tools for testing, but I did for planning
...
- need to track these 'omissions' as coverage gaps for later testing
...
- assume that testing has been done on the stories and all stories complete in the sprint and release.
- take a System view and ignore specific 'sprint', 'story' or 'release' requirements. View functionality as a whole.
- will not review automated execution. Risk of duplicated effort and scope.
